        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400 glass-dark px-4 py-3 rounded-lg border border-gold-400/20">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/about" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>About Us</span>
                </Link></li>
                <li><Link href="/services" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Services</span>
                </Link></li>
                <li><Link href="/courses" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Courses</span>
                </Link></li>
                <li><Link href="/universities" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Universities</span>
                </Link></li>
                <li><Link href="/partnerships" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/contact" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Contact Us</span>
                </Link></li>
                <li><Link href="/blog" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Blog & Resources</span>
                </Link></li>
                <li><Link href="/login" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Partner Login</span>
                </Link></li>
                <li><Link href="/register" className="text-gray-300 hover:text-gold-400 transition-colors flex items-center gap-2 group">
                  <span className="text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Register</span>
                </Link></li>
              </ul>
          ...
          {/* Bottom Bar */}
          <div className="border-t border-gold-400/20 mt-10 pt-8">
