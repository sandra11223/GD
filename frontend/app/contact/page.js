      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-gradient-to-br from-[#0a0e1a] via-[#0f1729] to-[#0a0e1a]">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left: Content */}
            <div>
              <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-emerald-500/10 rounded-full mb-6 animate-blurToFocus">
                <span className="relative flex h-2.5 w-2.5">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-400"></span>
                </span>
                <span className="text-xs font-semibold text-emerald-400 tracking-wider uppercase">We're Here to Help</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 animate-smoothSlideFade" style={{animationDelay: '0.5s'}}>
                <a href="mailto:info@globaleducation.com" className="px-6 py-3 bg-emerald-500 text-black font-semibold rounded-xl hover:bg-emerald-400 transition-all hover:scale-105 inline-flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  Email Us
                </a>
                <a href="tel:+12345678900" className="px-6 py-3 bg-white/5 text-emerald-400 font-semibold rounded-xl hover:bg-emerald-500/10 transition-all hover:scale-105 inline-flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="puzzle-glass-card">
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-6 group">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-500 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      <svg className="w-8 h-8 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-emerald-400 mb-3 text-lg">Email</h3>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-emerald-400 mb-3 text-lg">Phone</h3>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-emerald-400 mb-3 text-lg">Address</h3>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-emerald-400 mb-3 text-lg">Business Hours</h3>
            ...
            <div className="scroll-reveal animation-delay-200">
              <div className="puzzle-glass-card h-full flex flex-col">
                ...
                <p className="puzzle-text mb-8 leading-relaxed text-lg">
                  For inquiries and enrollment, please <a href="/login" className="text-emerald-400 hover:text-emerald-300 font-semibold underline">login</a> or <a href="/register" className="text-emerald-400 hover:text-emerald-300 font-semibold underline">register</a> to submit your inquiry through our portal.
                </p>
                ...
                <div className="puzzle-icon-card flex-1">
                  ...
                  <ul className="space-y-4">
                    <li>
                      <a href="/register" className="flex items-center gap-3 text-gray-300 hover:text-emerald-400 transition-colors group p-3 rounded-xl hover:bg-emerald-500/10">
                        <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="/login" className="flex items-center gap-3 text-gray-300 hover:text-emerald-400 transition-colors group p-3 rounded-xl hover:bg-emerald-500/10">
                        <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="/courses" className="flex items-center gap-3 text-gray-300 hover:text-emerald-400 transition-colors group p-3 rounded-xl hover:bg-emerald-500/10">
                        <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="/universities" className="flex items-center gap-3 text-gray-300 hover:text-emerald-400 transition-colors group p-3 rounded-xl hover:bg-emerald-500/10">
                        <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
