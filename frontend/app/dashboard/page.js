          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gold-500/20 to-gold-500/20 flex items-center justify-center text-gold-400 group-hover:scale-110 transition-transform">
                  {stat.icon}
                </div>
                {stat.total > 0 && (
              ...
              {/* Main Number */}
              <div className="mb-3">
                <div className="metric-number text-4xl mb-2 counter">
                  {stat.value}
                </div>
                <div className="text-gray-400 text-base font-medium">{stat.title}</div>
              </div>
              ...
              <Link href="/dashboard/browse-courses" className="block">
                <div className="info-card group cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-gold-500 to-gold-500 flex items-center justify-center text-black">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
        ...
        <div className="data-card p-6 animate-fadeInUp" style={{ animationDelay: '700ms' }}>
          ...
          {enrollments.length === 0 && partnerships.length === 0 && inquiries.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-300 text-lg mb-2">No activity yet</p>
              <p className="text-gray-400 text-sm mb-6">Start by browsing courses or submitting an inquiry</p>
