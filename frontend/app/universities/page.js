            ...
            <div className="lg:col-span-5 relative mt-12 lg:mt-0 flex items-center justify-center">
              <div className="relative w-full max-w-[280px] sm:max-w-md lg:max-w-lg aspect-square p-4 sm:p-8" style={{
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-gold-500/60 to-gold-600/40 backdrop-blur-md border-3 border-gold-400/70 rounded-full flex flex-col items-center justify-center text-center shadow-2xl shadow-gold-400/50 z-20 relative">
                  ...
                  <p className="text-[10px] sm:text-xs font-black text-white relative z-10 tracking-wide">GRADUATE</p>
                </div>
                ...
                <svg className="absolute inset-0 w-full h-full text-gold-400/70 pointer-events-none z-10">
                  ...
                  {/* Top to Center */}
                  <line x1="50%" y1="20%" x2="50%" y2="45%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterUni)" className="animate-pulse" style={{animationDelay: '0.2s'}}/>
                  {/* Right to Center */}
                  <line x1="80%" y1="50%" x2="55%" y2="50%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterUni)" className="animate-pulse" style={{animationDelay: '0.5s'}}/>
                  {/* Bottom to Center */}
                  <line x1="50%" y1="80%" x2="50%" y2="55%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterUni)" className="animate-pulse" style={{animationDelay: '0.8s'}}/>
                  {/* Left to Center */}
                  <line x1="20%" y1="50%" x2="45%" y2="50%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterUni)" className="animate-pulse" style={{animationDelay: '1.1s'}}/>
                </svg>
