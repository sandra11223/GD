  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div className="relative overflow-hidden glass-dark rounded-2xl border border-emerald-500/30 shadow-lg p-6 hover:shadow-emerald-500/20 transition-all group">
          ...
          <div className="relative">
            <div className="p-3 bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 rounded-xl border border-emerald-500/30 w-fit mb-4">
        ...
        <div className="relative overflow-hidden glass-dark rounded-2xl border border-green-500/30 shadow-lg p-6 hover:shadow-green-500/20 transition-all group">
          ...
          <div className="relative">
            <div className="p-3 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-xl border border-green-500/30 w-fit mb-4">
              <svg className="w-7 h-7 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
            <p className="text-4xl font-bold text-green-400 mb-2">{stats.totalPartnerships}</p>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        {/* Inquiries Status */}
        <div className="glass-dark rounded-2xl border border-emerald-500/20 shadow-lg p-6 hover:border-emerald-500/40 transition-all">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-white flex items-center">
              <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center mr-3 border border-emerald-500/30">
            ...
            <span className="text-2xl font-bold text-emerald-400">{stats.totalInquiries}</span>
          </div>
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-green-400 font-bold">{stats.inquiriesByStatus.resolved}</span>
              </div>
              <div className="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
                <div 
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-green-400 font-bold">{stats.enrollmentsByStatus.approved}</span>
              </div>
              <div className="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
                <div 
                  className="bg-gradient-to-r from-green-500 to-green-400 h-2 rounded-full transition-all duration-500"
        ...
        {/* Partnerships Status */}
        <div className="glass-dark rounded-2xl border border-green-500/20 shadow-lg p-6 hover:border-green-500/40 transition-all">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-white flex items-center">
              <div className="w-10 h-10 bg-green-500/10 rounded-xl flex items-center justify-center mr-3 border border-green-500/30">
            ...
            <span className="text-2xl font-bold text-green-400">{stats.totalPartnerships}</span>
          </div>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-300 text-sm font-medium">Approved</span>
                <span className="text-green-400 font-bold">{stats.partnershipsByStatus.approved}</span>
              </div>
              <div className="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
                <div 
                  className="bg-gradient-to-r from-green-500 to-green-400 h-2 rounded-full transition-all duration-500"
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {/* Popular Courses */}
        <div className="glass-dark rounded-xl border border-emerald-500/20 shadow-emerald-glow p-6">
          ...
          {stats.popularCourses.length === 0 ? (
            ...
            <div className="space-y-3">
              {stats.popularCourses.map((course, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-emerald-500/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-emerald-500/10 rounded-full flex items-center justify-center text-emerald-400 font-bold text-sm border border-emerald-500/30">
                      {index + 1}
                    </div>
          ...
          {stats.popularServices.length === 0 ? (
            ...
            <div className="space-y-3">
              {stats.popularServices.map((service, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-green-500/10 rounded-full flex items-center justify-center text-green-400 font-bold text-sm border border-green-500/30">
                      {index + 1}
                    </div>
      ...
      <div className="glass-dark rounded-xl border border-emerald-500/20 shadow-emerald-glow p-6">
        ...
        <div className="space-y-2 max-h-96 overflow-y-auto">
          {stats.recentActivity.map((activity, index) => (
            <div key={index} className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg border border-emerald-500/20 hover:border-emerald-500/40 transition-colors">
              <div className="flex items-center gap-3">
                <div className={`w-2 h-2 rounded-full ${
                  activity.type === 'inquiry' ? 'bg-emerald-400' :
