  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div className="relative overflow-hidden glass-dark rounded-2xl border border-gold-400/30 shadow-lg p-6 hover:shadow-gold-500/20 transition-all group">
        ...
        <div className="glass-dark rounded-2xl border border-gold-400/20 shadow-lg p-6 hover:border-gold-400/40 transition-all">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
                <div 
                  className="bg-gradient-to-r from-gold-500 to-green-400 h-2 rounded-full transition-all duration-500"
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {/* Popular Courses */}
        <div className="glass-dark rounded-xl border border-gold-400/20 shadow-gold-glow p-6">
